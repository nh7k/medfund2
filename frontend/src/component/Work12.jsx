      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="animate__animated animate__fadeIn">
            <h3 className="text-2xl font-bold text-white mb-4">MedFund</h3>
            <p className="text-gray-400 mb-6">
              Secure blockchain-powered medical crowdfunding platform connecting patients with verified hospitals.
            </p>
        ...
        <div className="border-t border-neutral-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">© 2024 MedFund. All rights reserved.</p>
